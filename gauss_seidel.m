function x_ks = gauss_seidel(A, b, x_0)
% Gauss Seidel - iteratively find increasingly improved approximations
...
while true
    ...
    for i = 1:n
        % compute next x using current x AND computed next x values
        % x_k_1(i) = (1 / A(i,i))*[b(i) 
